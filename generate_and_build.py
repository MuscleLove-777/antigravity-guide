...
def run(config, prompts=None):
    ...
    try:
        ...
        from seo_optimizer import AntigravitySEOOptimizer
        ...
        optimizer = AntigravitySEOOptimizer(config)
    ...
    try:
        from site_generator import AntigravitySiteGenerator
        site_gen = AntigravitySiteGenerator(config)
        site_gen.build_site()
